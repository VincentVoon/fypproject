...
if (isset ($_POST['submit'])){
    ...
    $insert = mysqli_query($conn, "INSERT INTO 'fyp_coding'(mobile, services, date, time, special)VALUES ('$mobile', '$services', '$date', '$time', '$special')") or die ('query failed');
        ...
        <div class="row gx-0 d-none d-lg-flex">
            ...
            <div class="col-lg-5 px-5 text-end">
                ...
                <div class="h-100 d-inline-flex align-items-center">
                    <a class=" bg-lightblue text-primary me-1" href="appointment.html"><i class="fas fa-user-plus me-1"></i></i>Login/Register
            </div>
        </div>
    </div>
    <!-- Topbar End -->
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="time" id="time" data-target-input="nearest">
                                        <input type="text"
                                            class="form-control border-0 datetimepicker-input"
                                            placeholder="Choose Date" name = "time" data-target="#time" data-toggle="datetimepicker" style="height: 55px;">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <textarea class="form-control border-0" rows="5" placeholder="Special Request" name = "special"></textarea>
                                </div>
                                <div class="col-12">
